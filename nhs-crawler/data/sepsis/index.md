...
- [antibiotics](/medicines/antibiotics/) – you may be given a general antibiotic to start with and then a more specific one after the cause of the infection has been confirmed
...
- ✅ eat ahealthy, balanced diet– if you have a reduced appetite, eating smaller meals more frequently may help
- ✅ exerciseregularly, but start slowly and build up gradually
...
> **💡 Information:** Find out more about recovering from sepsis on The UK Sepsis Trust website
...
Treatment for PSS involves treating the symptoms, and may include [physiotherapy](/tests-and-treatments/physiotherapy/), [counselling](/tests-and-treatments/counselling/) and additional help and support.
...
> **💡 Information:** Find out more about post-sepsis syndrome on The UK Sepsis Trust website
...
- chest infections ([pneumonia](/conditions/pneumonia/))
- [urinary tract infections (UTIs)](/conditions/urinary-tract-infections-utis/)
- abdominal infections, such as [appendicitis](/conditions/appendicitis/)
- skin infections, such as [cellulitis](/conditions/cellulitis/) or infected wounds
...
- Website: [www.sepsistrust.org](https://sepsistrust.org/)
- Helpline: 0808 800 0029
- [The UK Sepsis Trust: support](https://sepsistrust.org/get-support/)

> **💡 Information:** Information for people with a learning disability and their carers Easy read information about sepsis for people with a learning disability (NHS England) NHS Sherwood Forest Hospitals video about sepsis for people with a learning disability (YouTube) NHS Sherwood Forest Hospitals video about sepsis for families and carers of people with a learning disability (YouTube)
